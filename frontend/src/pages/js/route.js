...
const routeDefs = [
    ...
    {path: '/cmdExecute', component: () => import('../cmdExecute.vue'), meta: { title: '命令执行' }},
    ...
    {path: '/crypto_gen_key', component: () => import('../crypto_encryption.vue'), meta: { title: '公钥算法' }},
    {path: '/crypto_encryption', component: () => import('../crypto_encryption.vue'), meta: { title: '公钥算法' }},
