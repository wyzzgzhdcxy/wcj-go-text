  ...
  <div class="page-container">
    <div class="content-wrapper">
      ...
      <div class="button-group">
        <el-button type="success" @click="textEncode('url编码')">🔗 URL编码</el-button>
        <el-button type="success" @click="textEncode('url解码')">🔗 URL解码</el-button>
        <el-button type="success" @click="textEncode('base64编码')">📦 Base64编码</el-button>
        <el-button type="success" @click="textEncode('base64解码')">📦 Base64解码</el-button>
        <el-button type="success" @click="textEncode('md5')">🔑 MD5</el-button>
      </div>
      <div class="textarea-wrapper">
