  ...
  <div class="page-container">
    <div class="content-wrapper">
      <div class="textarea-wrapper">
        <textarea v-model="inputData" class="textarea" placeholder="输入文本，每行一个..."></textarea>
      </div>
      <div class="button-group">
        <el-button type="success" @click="forwardSort">⬆️ 正向排序</el-button>
        <el-button type="success" @click="reverseSort">⬇️ 逆向排序</el-button>
        <el-button type="success" @click="reverse">🔃 倒序</el-button>
        <el-button type="success" @click="exchange">🔄 交换</el-button>
      </div>
      <div class="textarea-wrapper">
...
export default {
  ...
  methods: {
    ...
    reverseSort() {
      ...
      let arr = this.inputData.split('\n')
      arr.sort(function (a, b) {
        return b.localeCompare(a, 'zh-Hans-CN', {sensitivity: 'base'});
      });
      this.result = arr.join("\n")
    },
    reverse() {
