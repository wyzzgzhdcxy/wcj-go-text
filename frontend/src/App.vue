    ...
    <aside class="app-sidebar" :class="{ collapsed }">
      ...
      <nav class="sidebar-nav">
        ...
        <template v-else>
          ...
          <div v-if="visibleToolsNav.git.length" class="nav-group-label">Git</div>
          <router-link
            v-for="item in visibleToolsNav.git"
            :key="item.path"
            :to="item.path"
            class="nav-item"
            :class="{ active: $route.path === item.path }"
  ...
  data() {
    return {
      ...
      toolsNav: {
        ...
        git: [
          { path: '/gitSync',     label: 'Git同步',   icon: 'Promotion' },
        ],
      },
    };
  },
  computed: {
    ...
    visibleToolsNav() {
      ...
      return {
        ...
        git: filterFn(this.toolsNav.git),
      };
    },
  },
  methods: {
    ...
    buildMenuGroups() {
      ...
      const toolsGroupDefs = [
        ...
        { key: 'git',      label: 'Git',   icon: 'Promotion' },
      ];
      const groups = [];
